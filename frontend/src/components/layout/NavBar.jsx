...
const NavBar = () => {
  ...
  return (
    <section className="bg-[#15161D] px-4 py-4">
            ...
            {navItems.map((item) => {
              ...
              return (
                <motion.a
                  ...
                  className={`group relative h-[24px] overflow-hidden text-white font-medium text-[15px] ${isActive ? "text-#277CD9" : "hover:text-[#277CD9]"}`}
                >
